...
class $ProductsTable extends Products
  ...
  @override
  List<GeneratedColumn> get $columns => [id, name, barcode, price];
  @override
...
class ProductData extends DataClass implements Insertable<ProductData> {
  ...
  ProductData copyWith(
          {String? id, String? name, String? barcode, double? price}) =>
      ProductData(
        id: id ?? this.id,
        name: name ?? this.name,
  ...
  @override
  int get hashCode => Object.hash(id, name, barcode, price);
  @override
...
class $$ProductsTableTableManager extends RootTableManager<
    ...
    (ProductData, BaseReferences<_$AppDb, $ProductsTable, ProductData>),
    ProductData,
